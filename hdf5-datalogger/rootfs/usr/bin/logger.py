...
- Filtro domini semplice via include_domains (lista)
- Log di tutti gli attributi
- Log esteso nel log dell'add-on ad ogni run
"""
...
def main():
    ...
    # 3) Applica include_domains (se valorizzato) con default
    ...
    # 5) Log esteso nel log dell'add-on
    ...
    print("[INFO] Domini disponibili (dopo filtro fisico): " + ", ".join(sorted(available_domains)) if available_domains else "[INFO] Domini disponibili: (nessuno)")
